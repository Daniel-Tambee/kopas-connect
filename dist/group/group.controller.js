...
const manage_group_membership_dto_1 = require("./manage-group-membership.dto");
let GroupController = class GroupController {
    ...
    addUserToGroup(id, manageGroupMembershipDto) {
        return this.groupService.addUserToGroup(+id, manageGroupMembershipDto);
    }
    removeUserFromGroup(id, manageGroupMembershipDto) {
...
__decorate([
    (0, common_1.Patch)(':id/add-user'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, manage_group_membership_dto_1.ManageGroupMembershipDto]),
    __metadata("design:returntype", void 0)
], GroupController.prototype, "addUserToGroup", null);
__decorate([
    (0, common_1.Patch)(':id/remove-user'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, manage_group_membership_dto_1.ManageGroupMembershipDto]),
